...
class core_captcha
{
	...
	{
		if (!$captcha_fonts = BOP_APP::cache()->get('captcha_fonts'))
		{
			$captcha_fonts = fetch_file_lists(BOG_PATH . 'core/fonts/');
			
			BOP_APP::cache()->set('captcha_fonts', $captcha_fonts, get_setting('cache_level_normal'));
		}
