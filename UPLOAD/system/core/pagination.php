...
class core_pagination
{
	...
	{		
		if (file_exists(ROOT_PATH . 'themes/' . get_setting('ui_style') . '/config/pagination.php'))
		{
			include(ROOT_PATH . 'themes/' . get_setting('ui_style') . '/config/pagination.php');
		}
		else
		{
			include(ROOT_PATH . 'themes/default/config/pagination.php');
		}
