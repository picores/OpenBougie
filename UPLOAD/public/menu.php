...
{	
	...
	{
		BOP_APP::cache()->cleanGroup('nav_menu');
	...
	{
		if (!$nav_menu_data = BOP_APP::cache()->get('nav_menu_list'))
		{
			$nav_menu_data = $this->fetch_all('nav_menu', null, 'sort ASC');
			
			BOP_APP::cache()->set('nav_menu_list', $nav_menu_data, get_setting('cache_level_low'), 'nav_menu');
		}
